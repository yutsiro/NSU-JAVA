...
public class Client2 {
    ...
    public Client2(String ip, String mac, String routerHost, int routerPort) {
        this.ip = ip;
        this.mac = mac;
    ...
    public static void main(String[] args) throws IOException {
        Client2 client = new Client2("192.168.1.4", "00:1A:2B:3C:4D:04", "localhost", 9999);
        client.connect();

        BufferedReader console = new BufferedReader(new InputStreamReader(System.in));
        while (client.running) {
            System.out.print("Введите IP для PING (или 'exit' для выхода): ");
            try {
