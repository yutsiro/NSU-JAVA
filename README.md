# NSU-JAVA
Лабораторные работы по курсу ООП на Java и сетевым технологиям
...
### [Места (Асинхронное сетевое взаимодействие)](https://github.com/yutsiro/NSU-JAVA/tree/main/nets_l3)
Приложение, которое по названию места находит его координаты, показывает текущую погоду и интересные достопримечательности поблизости.
### [SOCKS-прокси](https://github.com/yutsiro/NSU-JAVA/tree/main/nets_l5)
Прокси-сервер, соответствующий стандарту SOCKS версии 5.
### [Змейка по сети](https://github.com/yutsiro/NSU-JAVA/tree/main/snake_l4)
